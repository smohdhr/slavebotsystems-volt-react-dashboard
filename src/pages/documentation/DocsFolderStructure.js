        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">Learn more about the file structure for SlavebotSystems React Dashboard</p>
              ...
              <ul className="docs-list">
                ...
                <li><code>scss/</code> - holds the variables, mixins and custom component styles developed by Themesberg for SlavebotSystems React Dashboard</li>
                <li><code>index.js</code> - is the JavaScript entry point</li>
                <li><code>routes.js</code> - exports an object with all the route paths found in SlavebotSystems React Dashboard</li>
              </ul>
